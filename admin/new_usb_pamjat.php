                    ...
                    <div id="forma">
                        <form id="form1" method="post" action="add_usb_pamjat.php">
                            <table width="680" border="0" cellspacing="10" cellpadding="340">
                                ...
                                <tr>
                                    <td><label>Ссылка на изображение <em>(пример: usb_pamjat/fl_8.jpg)</em>. Изображение
                                            предварительно загрузить по ftp. Требование к изображению: не должно
                                            превышать 220px по ширине</label></td>
