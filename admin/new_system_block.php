...
<div id="wrapper">
    ...
    <div id="page">
        ...
        <div id="bgbottom">
            ...
            <!-- начало Right -->
            <div id="right">
                <div id="text"><h1>Добавление нового системного блока</h1><br /></div>
                <div id="text"><br/>
                    <div id="forma">
                        <form id="form1" method="post" action="add_system_block.php" >
                            <table  border="0" cellspacing="10" cellpadding="340">
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" id="name_system_block" name="name_system_block" value="<?php echo $row['name_system_block'];?>"/><br/>
                                    </td>
                                </tr>
                                <!-- Процессор (cpu)-->
                                <tr height="25px">
                                    ...
                                    <td >
                                        <select  name="cpu" id="cpu" ><!--style="font-size:11px;width:500px;"-->
                                            ...
                                            <?php
                                                $result = mysql_query("SELECT cpu.* FROM  cpu, cpu_system_block WHERE cpu.id= cpu_system_block.id_cpu  AND cpu_system_block.id_system_block = " . 0 . 'ORDER BY cpu.name_cpu', $db);
                                ...
                                <tr>
                                    <td id="td_add_cpu" style="display:none">
                                        ...
                                        <script type="text/javascript">
                                            ...
                                            function deleteCpu()
                                            {
                                                ...
                                                area.load('delete_cpu.php',{cpu_id : cpuValue});
                                            }
                                            ...
                                            function addCpu()
                                            {
                                                ...
                                                area.load('add_cpu.php',{name_cpu : nameCpu, speed_cpu : speedCpu,number_cores_cpu : numberCoresCpu});
                                            }
                                    ...
                                    <td id="td_add_existing_cpu" style="display:none">
                                        ...
                                        <select  name="existing_cpu" id="existing_cpu" >
                                            <option value="0" selected="selected">Процессор</option>
                                            <?php
                                                $result = mysql_query("SELECT cpu.* FROM  cpu ORDER BY name_cpu ASC", $db);
                                                while($row = mysql_fetch_assoc($result))
                                                {
                                                    echo  '<option value="'.  $row['id'].'">' . $row['name_cpu'] . ' Core ' . $row['number_cores_cpu'] . ' ' . $row['speed_cpu'] . 'Гц </option>';
                                                }
                                        ...
                                        <script type="text/javascript">
                                            ...
                                            function addExistingCpu()
                                            {
                                                ...
                                                area.load('add_cpu.php',{id_existing_cpu : ExistingCpuValue});
                                            }
                                ...
                                <tr height="25px">
                                    ...
                                    <td >
                                        <select    name="hdd" id="hdd">
                                            ...
                                            <?php
                                                $result = mysql_query("SELECT hdd.* FROM  hdd, hdd_system_block WHERE hdd.id= hdd_system_block.id_hdd  AND hdd_system_block.id_system_block = " . 0 , $db);
                                                while($row = mysql_fetch_assoc($result))
                                                {
                                ...
                                <tr>
                                    <td id="td_add_hdd" style="display:none">
                                        ...
                                        <script type="text/javascript">
                                            ...
                                            function deleteHdd() {
                                                ...
                                                area.load('delete_hdd.php',{hdd_id : hddValue});
                                            }
                                            ...
                                            function addHdd() {
                                                ...
                                                area.load('add_hdd.php',{name_hdd : nameHdd, size_hdd : sizeHdd});
                                            }
                                    ...
                                    <td id="td_add_existing_hdd" style="display:none">
                                        ...
                                        <select    name="existing_hdd" id="existing_hdd">
                                            <option value="0" selected="selected">Жесткий диск</option>
                                            <?php
                                                $result = mysql_query("SELECT hdd.* FROM  hdd ORDER BY name_hdd,size_hdd" , $db);
                                                while($row = mysql_fetch_assoc($result))
                                                {
                                                    echo  '<option value="'.  $row['id'].'"> ' . $row['name_hdd'] . ' ' . $row['size_hdd'] . 'GB</option>';
                                                }
                                        ...
                                        <script type="text/javascript">
                                            ...
                                            function addExistingHdd()
                                            {
                                                ...
                                                area.load('add_hdd.php',{id_existing_hdd : ExistingHddValue});
                                            }
                                ...
                                <tr height="25px">
                                    ...
                                    <td >
                                        <select    name="random_access_memory" id="random_access_memory">
                                            ...
                                            <?php
                                                $result = mysql_query("SELECT random_access_memory.* FROM  random_access_memory, random_access_memory_system_block WHERE random_access_memory.id= random_access_memory_system_block.id_random_access_memory  AND random_access_memory_system_block.id_system_block = " . 0 . 'ORDER BY  random_access_memory.size_random_access_memory', $db);
                                                while($row = mysql_fetch_assoc($result))
                                                {
                                ...
                                <tr>
                                    <td id="td_add_random_access_memory" style="display:none">
                                        ...
                                        <input type="button" id="add_random_access_memory" name="add_random_access_memory" value="Добавить оперативную память">
                                        ...
                                        <script type="text/javascript">
                                            ...
                                            function deleteRandomAccessMemory()
                                            {
                                                ...
                                                area.load('delete_random_access_memory.php',{random_access_memory_id : randomAccessMemoryValue});
                                            }
                                            ...
                                            function addRandomAccessMemory()
                                            {
                                                ...
                                                area.load('add_random_access_memory.php',{name_random_access_memory : nameRandomAccessMemory, size_random_access_memory : sizeRandomAccessMemory});
                                            }
                                    ...
                                    <td id="td_add_existing_random_access_memory" style="display:none">
                                        ...
                                        <input type="button" id="add_existing_random_access_memory" name="add_random_access_memory" value="Добавить оперативную память">
                                        ...
                                        <script type="text/javascript">
                                            ...
                                            function addExistingRandomAccessMemory()
                                            {
                                                ...
                                                area.load('add_random_access_memory.php',{id_existing_random_access_memory : ExistingRandomAccessMemoryValue});
                                            }
                                ...
                                <tr height="25px">
                                    ...
                                    <td >
                                        <input type="checkbox" id="optical_drive" name="optical_drive" checked="checked">
                                    </td>
                                </tr>
                                ...
                                <tr height="25px">
                                    ...
                                    <td >
                                        <select    name="motherboard" id="motherboard">
                                            ...
                                            <?php
                                            //$result = mysql_query("SELECT * FROM  motherboard", $db);
                                            $result = mysql_query("SELECT motherboard.* FROM   motherboard, motherboard_system_block WHERE motherboard.id= motherboard_system_block.id_motherboard  AND motherboard_system_block.id_system_block = " . 0 . 'ORDER BY motherboard.name_motherboard', $db);
                                            while($row = mysql_fetch_assoc($result))
                                            {
                                                ?>
                                                <option value="<?php echo $row['id']?>"><?php echo $row['name_motherboard']?></option>
                                                <?php
                                            }
                                    ...
                                    <td id="td_add_motherboard" style="display:none">
                                        ...
                                        <script type="text/javascript">
                                            ...
                                            function deleteMotherboard() {
                                                ...
                                                area.load('delete_motherboard.php',{motherboard_id : motherboardValue});
                                            }
                                    ...
                                    <td id="td_add_existing_motherboard" style="display:none">
                                        ...
                                        <script type="text/javascript">
                                            ...
                                            function addExistingMotherboard()
                                            {
                                                ...
                                                area.load('add_motherboard.php',{id_existing_motherboard : ExistingMotherboardValue});
                                            }
                                ...
                                <tr height="25px">
                                    ...
                                    <td >
                                        <select    name="computer_case" id="computer_case">
                                            ...
                                            <?php
                                           // $result = mysql_query("SELECT * FROM  computer_case", $db);
                                            $result = mysql_query("SELECT computer_case.* FROM  computer_case, computer_case_system_block WHERE computer_case.id= computer_case_system_block.id_computer_case  AND computer_case_system_block.id_system_block = " . 0 .   'ORDER BY computer_case.name_computer_case', $db);
                                    ...
                                    <td id="td_add_computer_case" style="display:none">
                                        ...
                                        <script type="text/javascript">
                                            ...
                                            function deleteComputerCase() {
                                                ...
                                                area.load('delete_computer_case.php',{computer_case_id : computerCaseValue});
                                            }

                                            function addComputerCase() {
                                                var area = $("#computer_case");
                                                var nameComputerCase = $("#name_computer_case").val();
                                                area.load('add_computer_case.php',{name_computer_case : nameComputerCase});
                                            }
                                    ...
                                    <td id="td_add_existing_computer_case" style="display:none">
                                        ...
                                        <script type="text/javascript">
                                            ...
                                            function addExistingСomputerCase()
                                            {
                                                ...
                                                area.load('add_computer_case.php',{id_existing_computer_case : ExistingСomputerCaseValue});
                                            }
                                ...
                                <tr height="25px">
                                    ...
                                    <td >
                                        <select    name="vga" id="vga" >
                                            ...
                                            <?php
                                                $result = mysql_query("SELECT vga.* FROM   vga, vga_system_block WHERE vga.id= vga_system_block.id_vga  AND vga_system_block.id_system_block = " . 0 .   'ORDER BY vga.name_vga', $db);
                                                while($row = mysql_fetch_assoc($result))
                                                {
                                        ...
                                        <script type="text/javascript">
                                            $(document).ready(function() {
                                                        $("#delete_vga").click(function() {
                                                            var cpuValue = $("#vga option:selected").val();
                                                            deleteVga();
                                                        })
                                                    }
                                            ...
                                            function deleteVga() {
                                                ...
                                                area.load('delete_vga.php',{vga_id : vgaValue});
                                ...
                                <tr>
                                    <td id="td_add_vga" style="display:none">
                                        ...
                                        <script type="text/javascript">
                                            ...
                                            function addVga()
                                            {
                                                ...
                                                area.load('add_vga.php',{name_vga : nameVga, size_vga : sizeVga});
                                            }
                                    ...
                                    <td id="td_add_existing_vga" style="display:none">
                                        ...
                                        <select    name="existing_vga" id="existing_vga">
                                            ...
                                            <?php
                                                $result = mysql_query("SELECT vga.* FROM  vga ORDER BY vga.name_vga" , $db);
                                                while($row = mysql_fetch_assoc($result))
                                                {
                                                    echo  '<option value="'.  $row['id'].'"> ' . $row['name_vga'] . ' ' . $row['size_vga'] . 'GB</option>';
                                                }
                                        ...
                                        <script type="text/javascript">
                                            ...
                                            function addExistingVga()
                                            {
                                                ...
                                                area.load('add_vga.php',{id_existing_vga : ExistingVgaValue});
                                            }
                                ...
                                <tr height="25px">
                                    ...
                                    <td >
                                        <select    name="power_unit" id="power_unit" >
                                            ...
                                            <?php
                                                $result = mysql_query("SELECT power_unit.* FROM   power_unit, power_unit_system_block WHERE power_unit.id= power_unit_system_block.id_power_unit  AND power_unit_system_block.id_system_block = " . 0 .   'ORDER BY power_unit.size_power_unit', $db);
                                ...
                                <tr>
                                    <td id="td_add_power_unit" style="display:none">
                                        ...
                                        <script type="text/javascript">
                                            ...
                                            function deletePowerUnit()
                                            {
                                                ...
                                                area.load('delete_power_unit.php',{power_unit_id : powerUnitValue});
                                            }
                                            ...
                                            function addPowerUnit()
                                            {
                                                ...
                                                area.load('add_power_unit.php',{name_power_unit : namePowerUnit, size_power_unit : sizePowerUnit});
                                            }
                                    ...
                                    <td id="td_add_existing_power_unit" style="display:none">
                                        ...
                                        <select    name="existing_power_unit" id="existing_power_unit">
                                            ...
                                            <?php
                                                $result = mysql_query("SELECT power_unit.* FROM  power_unit ORDER BY size_power_unit" , $db);
                                                while($row = mysql_fetch_assoc($result))
                                                {
                                                    echo  '<option value="'.  $row['id'].'"> ' . $row['name_power_unit'] . ' ' . $row['size_power_unit'] . 'Вт</option>';
                                                }
                                        ...
                                        <script type="text/javascript">
                                            ...
                                            function addExistingPowerUnit()
                                            {
                                                ...
                                                area.load('add_power_unit.php',{id_existing_power_unit : ExistingPowerUnitValue});
                                            }
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input name="cost" type="text" id="cost" size="20" />
                                    </td>
                                </tr>

                                <tr>
                                    <td colspan="2">
                                        <input type="submit" name="submit" id="submit" value="Добавить системный блок" />
                                    </td>
                                    <td></td>
                                </tr>
