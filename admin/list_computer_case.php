    ...
    <div id="page">
        ...
        <div id="bgbottom">
            ...
            <div id="right">
                ...
                <div id="text">
                    <?php
                    $result = mysql_query("SELECT distinct(computer_case.id), computer_case.name_computer_case,system_block.id_computer_case FROM  computer_case
                                                LEFT JOIN system_block ON computer_case.id = system_block.id_computer_case ORDER BY computer_case.name_computer_case", $db);
                    ...
                    <table id='table_edit' ALIGN='center' CELLSPACING='2px'  bgcolor='#ffffff'>
                        <form action='drop_computer_case.php' method='post'>
                            <?php
                            ...
                            ?>
                                <tr valign="top" align="left">
                                    <td id="td_edit">
                                        <a title="Редактировать" href="edit_computer_case.php?id_computer_case=<?php echo $row['id'];?>">
                                    ...
                                    <td id="td_edit1">
                                        <strong>
                                            ...
                                            $resultComputerCase = mysql_query("SELECT * FROM  system_block
                                                       ...
                                                       WHERE computer_case.id=" . $row['id'], $db);


                                            $showDeleteSubmit = 1;

                                            while($row1 = mysql_fetch_assoc($resultComputerCase))
                                            {
                                                $showDeleteSubmit = 0;
                                    ...
                                    if ($showDeleteSubmit != 0)
                                    {
                                        ?>
                                        <td id="td_radio">
                                            <input id="radio" type="radio" value="<?php echo $row['id'];?>" name="id_computer_case">
                                        </td>
                                        <td id="td_edit">
