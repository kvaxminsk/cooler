...
if (isset($title) && isset($image) && isset($image_alt) && isset($image_title) && isset($beznal) && isset($beznal_sb) && isset($beznal_monitor) && isset($beznal_keyboard) && isset($beznal_mouse) && isset($beznal_loudspeakers) && isset($processor) && isset($hdd) && isset($ram) && isset($optical_drive) && isset($motherboard) && isset($housing) && isset($vga) && isset($monitor) && isset($loudspeakers) && isset($information) && isset($date)) {
    $result = mysql_query("INSERT INTO beznal_computer (title,image,image_alt,image_title,beznal,beznal_sb,beznal_monitor,beznal_keyboard,beznal_mouse,beznal_loudspeakers,processor,hdd,ram,optical_drive,motherboard,housing,vga,monitor,loudspeakers,information,date) VALUES ('$title','$image','$image_alt','$image_title','$beznal','$beznal_sb','$beznal_monitor','$beznal_keyboard','$beznal_mouse','$beznal_loudspeakers','$processor','$hdd','$ram','$optical_drive','$motherboard','$housing','$vga','$monitor','$loudspeakers','$information','$date')");
