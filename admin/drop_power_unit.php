...
if (isset($_POST['id_power_unit'])) {$idPowerUnit = (int) htmlspecialchars(trim($_POST['id_power_unit']));}
    ...
    <div id="page">
        ...
        <div id="bgbottom">
            ...
            <div id="right">
                ...
                <div id="text">
                    <?php
                    if (isset($idPowerUnit))
                    {

                        $result = mysql_query("DELETE FROM power_unit WHERE id=$idPowerUnit");
                        if ($result == 'true')
                        {
