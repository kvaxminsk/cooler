    ...
    <div id="page">
        ...
        <div id="bgbottom">
            ...
            <div id="right">
                ...
                <div id="text">
                    <?php
                    $result = mysql_query("SELECT distinct(random_access_memory.id), random_access_memory.name_random_access_memory,random_access_memory.size_random_access_memory,system_block.id_random_access_memory FROM  random_access_memory
                                                LEFT JOIN system_block ON random_access_memory.id = system_block.id_random_access_memory ORDER BY random_access_memory.name_random_access_memory, random_access_memory.size_random_access_memory", $db);
                    ...
                    <table id='table_edit' ALIGN='center' CELLSPACING='2px'  bgcolor='#ffffff'>
                        <form action='drop_random_access_memory.php' method='post'>
                            <?php
                            while($row = mysql_fetch_assoc($result))
                            {
                                ...
                                <tr valign="top" align="left">
                                    <td id="td_edit">
                                        <a title="Редактировать" href="edit_random_access_memory.php?id_random_access_memory=<?php echo $row['id'];?>">
                                    ...
                                    <td id="td_edit1">
                                        <strong>
                                            ...
                                            $resultHdd = mysql_query("SELECT * FROM  system_block
                                                       ...
                                                       WHERE random_access_memory.id=" . $row['id'], $db);


                                            $showDeleteSubmit = 1;

                                            while($row1 = mysql_fetch_assoc($resultHdd))
                                            {
                                                $showDeleteSubmit = 0;
                                    ...
                                    if ($showDeleteSubmit != 0)
                                    {
                                        ?>
                                        <td id="td_radio">
                                            <input id="radio" type="radio" value="<?php echo $row['id'];?>" name="id_random_access_memory">
                                        </td>
                                        <td id="td_edit">
