    ...
    <div id="page">
        ...
        <div id="bgbottom">
            ...
            <div id="right">
                ...
                <div id="text">
                    <?php
                    $result = mysql_query("SELECT distinct(hdd.id), hdd.name_hdd,hdd.size_hdd,system_block.id_hdd FROM  hdd
                                                LEFT JOIN system_block ON hdd.id = system_block.id_hdd ORDER BY hdd.name_hdd, hdd.size_hdd", $db);
                    ...
                    <table id='table_edit' ALIGN='center' CELLSPACING='2px'  bgcolor='#ffffff'>
                        <form action='drop_hdd.php' method='post'>
                            <?php
                            while($row = mysql_fetch_assoc($result))
                            {
                                ...
                                <tr valign="top" align="left">
                                    <td id="td_edit">
                                        <a title="Редактировать" href="edit_hdd.php?id_hdd=<?php echo $row['id'];?>">
                                    ...
                                    if ($showDeleteSubmit != 0)
                                    {
                                        ?>
                                        <td id="td_radio">
                                            <input id="radio" type="radio" value="<?php echo $row['id'];?>" name="id_hdd">
                                        </td>
                                        <td id="td_edit">
