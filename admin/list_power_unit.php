    ...
    <div id="page">
        ...
        <div id="bgbottom">
            ...
            <div id="right">
                ...
                <div id="text">
                    <?php
                    $result = mysql_query("SELECT distinct(power_unit.id), power_unit.name_power_unit,power_unit.size_power_unit,system_block.id_power_unit FROM  power_unit
                                                LEFT JOIN system_block ON power_unit.id = system_block.id_power_unit ORDER BY power_unit.size_power_unit", $db);
                    ...
                    <table id='table_edit' ALIGN='center' CELLSPACING='2px'  bgcolor='#ffffff'>
                        <form action='drop_power_unit.php' method='post'>
                            <?php
                            while($row = mysql_fetch_assoc($result))
                            {
                                ...
                                <tr valign="top" align="left">
                                    <td id="td_edit">
                                        <a title="Редактировать" href="edit_power_unit.php?id_power_unit=<?php echo $row['id'];?>">
                                    ...
                                    <td id="td_edit1">
                                        <strong>
                                            ...
                                            $resultPowerUnit = mysql_query("SELECT * FROM  system_block
                                                       ...
                                                       WHERE hdd.id=" . $row['id'], $db);


                                            $showDeleteSubmit = 1;

                                            while($row1 = mysql_fetch_assoc($resultPowerUnit))
                                            {
                                                $showDeleteSubmit = 0;
                                    ...
                                    if ($showDeleteSubmit != 0)
                                    {
                                        ?>
                                        <td id="td_radio">
                                            <input id="radio" type="radio" value="<?php echo $row['id'];?>" name="id_power_unit">
                                        </td>
                                        <td id="td_edit">
