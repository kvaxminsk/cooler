...
<head>
    ...
    <title>Добавление Веб-камер</title>
...
<div id="wrapper">
    ...
    <div id="page">
        ...
        <div id="bgbottom">
            ...
            <!-- начало Right -->
            <div id="right">
                <div id="text"><h1>Добавление Веб-камер</h1><br/></div>
                <div id="text"><br/>
                    <?php
  ...
  <tr>
	...
	<td id='td_tabl_sbor'><a href='edit_veb_kamera.php'>Редактировать</a></td>
                    ...
                    <div id="forma">
                        ...
                        ?>
                        <form id="form1" method="post" action="add_veb_kamera.php">
                            <table width="680" border="0" cellspacing="10" cellpadding="340">
                                <tr>
                                    <td><label>Ссылка на маленькое изображение <em>(пример: veb-kamera/small/6.jpg)</em>.
                                            Изображение предварительно загрузить по ftp. Требование к изображению:
                                            ширина
                                            жесткая <strong>135px</strong>. </label></td>
                                    <td><input name="image_small" type="text" id="image_small" size="60"/></td>
                                </tr>
                                <tr>
                                    <td><label>Ссылка на большое изображение <em>(пример: veb-kamera/6.jpg)</em>.
