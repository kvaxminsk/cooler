...
<tr>
    <td id="td_add_operating_system" style="display:none">
        ...
        <input type="button" id="add_operating_system" name="add_operating_system"
               value="Добавить Операционная система">
...
<tr>
    ...
    <td>
        ...
        <select name="operating_system_version" id="operating_system_version"><!--style="font-size:11px;width:500px;"-->
            ...
            ?>
            <td>
                <input type="button" id="delete_operating_system_version" name="delete_operating_system_version"
                       value="Удалить"/>
            </td>
        </select>
    </td>
...
<tr>
    <td id="td_add_operating_system_version" style="display:none">
        ...
        <input type="button" id="add_operating_system_version" name="add_operating_system_version"
               value="Добавить Версия операционной системы ">
...
<tr>
    ...
    <td>
        ...
        <select name="graphics_accelerator" id="graphics_accelerator"><!--style="font-size:11px;width:500px;"-->
            ...
            ?>
            <td>
                <input type="button" id="delete_graphics_accelerator" name="delete_graphics_accelerator"
                       value="Удалить"/>
            </td>
        </select>
    </td>
...
<tr>
    <td id="td_add_graphics_accelerator" style="display:none">
        ...
        <input type="button" id="add_graphics_accelerator" name="add_graphics_accelerator"
               value="Добавить Графический ускоритель">
...
<tr>
    <td id="td_add_battery_capacity" style="display:none">
        ...
        <input type="button" id="add_battery_capacity" name="add_battery_capacity"
               value="Добавить Емкость аккумулятора">
...
<tr>
    ...
    <td>
        <input type="checkbox" name="accelerometer"
               id="accelerometer" <?php echo $rowTablet['accelerometer'] ? 'checked="checked"' : ''; ?>/>
    </td>
</tr>
...
<tr>
    ...
    <td>
        <input type="checkbox" name="gyroscope"
               id="gyroscope" <?php echo $rowTablet['gyroscope'] ? 'checked="checked"' : ''; ?>/>
    </td>
</tr>
...
<tr>
    ...
    <td>
        <input type="checkbox" name="proximity_sensor"
               id="proximity_sensor" <?php echo $rowTablet['proximity_sensor'] ? 'checked="checked"' : ''; ?>/>
    </td>
</tr>
...
<tr>
    ...
    <td>
        <!--                                        <input type="text" id="design" name="design" value="-->
        <?php //echo $row['design'];?><!--"/><br/>-->
        <select name="type_of_matrix_screen" id="type_of_matrix_screen">
            <!--style="font-size:11px;type_of_matrix_screen:500px;"-->
            ...
            ?>
            <td>
                <input type="button" id="delete_type_of_matrix_screen" name="delete_type_of_matrix_screen"
                       value="Удалить"/>
            </td>
        </select>
    </td>
...
<tr>
    <td id="td_add_type_of_matrix_screen" style="display:none">
        ...
        <input type="button" id="add_type_of_matrix_screen" name="add_type_of_matrix_screen"
               value="Добавить Тип матрицы экрана">
...
<tr>
    ...
    <td>
        <input type="checkbox" name="multi_touch"
               id="multi_touch" <?php echo !empty($rowTablet['multi_touch']) ? 'checked="checked"' : ''; ?>/>
    </td>
    <td>
        <input type="text" name="text_multi_touch" id="text_multi_touch"
               value="<?php echo !empty($rowTablet['multi_touch']) ? $rowTablet['text_multi_touch'] : ''; ?>"/>
    </td>
</tr>
...
<tr>
    ...
    <td>
        <input type="checkbox" name="protection_from_scratches"
               id="protection_from_scratches" <?php echo !empty($rowTablet['protection_from_scratches']) ? 'checked="checked"' : ''; ?>/>
    </td>
...
<tr>
    ...
    <td>
        <input type="checkbox" name="memory_cards"
               id="memory_cards" <?php echo !empty($rowTablet['memory_cards']) ? 'checked="checked"' : ''; ?>/>
    </td>
    <td>
        <input type="text" name="text_memory_cards" id="text_memory_cards"
               value="<?php echo !empty($rowTablet['memory_cards']) ? $rowTablet['text_memory_cards'] : ''; ?>"/>
    </td>
</tr>
...
<tr>
    ...
    <td>
        <input type="checkbox" name="built-in_camera"
               id="built-in_camera" <?php echo !empty($rowTablet['built-in_camera']) ? 'checked="checked"' : ''; ?>/>
    </td>
...
<tr>
    ...
    <td>
        <!--                                        <input type="text" id="design" name="design" value="-->
        <?php //echo $row['design'];?><!--"/><br/>-->
        <select name="number_of_active_pixels" id="number_of_active_pixels">
            <!--style="font-size:11px;number_of_active_pixels:500px;"-->
            ...
            ?>
            <td>
                <input type="button" id="delete_number_of_active_pixels" name="delete_number_of_active_pixels"
                       value="Удалить"/>
            </td>
        </select>
    </td>
...
<tr>
    <td id="td_add_number_of_active_pixels" style="display:none">
        ...
        <input type="button" id="add_number_of_active_pixels" name="add_number_of_active_pixels"
               value="Добавить Количество активных пикселей">
...
<tr>
    <td>
        <label for="number_of_active_pixels_front_camera" style="color:black;font-size:15px;">Количество активных
            пикселей фронтальной камеры:</label>
    </td>
    <td>
        <!--                                        <input type="text" id="design" name="design" value="-->
        <?php //echo $row['design'];?><!--"/><br/>-->
        <select name="number_of_active_pixels_front_camera" id="number_of_active_pixels_front_camera">
            <!--style="font-size:11px;number_of_active_pixels_front_camera:500px;"-->
            ...
            ?>
            <td>
                <input type="button" id="delete_number_of_active_pixels_front_camera"
                       name="delete_number_of_active_pixels_front_camera" value="Удалить"/>
            </td>
        </select>
    </td>
</tr>
<tr>
    <td>
        <div style="color:red" id="div_add_number_of_active_pixels_front_camera">Добавить Количество активных пикселей
            фронтальной камеры
        </div>
    </td>
</tr>
<tr>
    <td id="td_add_number_of_active_pixels_front_camera" style="display:none">
        ...
        <input type="text" id="name_number_of_active_pixels_front_camera"
               name="name_number_of_active_pixels_front_camera">

        </br>
        </br>
        <input type="button" id="add_number_of_active_pixels_front_camera"
               name="add_number_of_active_pixels_front_camera"
               value="Добавить Количество активных пикселей фронтальной камеры">
...
<tr>
    ...
    <td>
        <input type="checkbox" name="built-in_microphone"
               id="built-in_microphone" <?php echo !empty($rowTablet['built-in_microphone']) ? 'checked="checked"' : ''; ?>/>
    </td>
</tr>
...
<tr>
    <td id="td_add_built_in_speakers" style="display:none">
        ...
        <input type="button" id="add_built_in_speakers" name="add_built_in_speakers"
               value="Добавить Встроенные динамики">
...
<tr>
    ...
    <td>
        <input type="checkbox" name="bluetooth"
               id="bluetooth" <?php echo !empty($rowTablet['bluetooth']) ? 'checked="checked"' : ''; ?>/>
    </td>
    <td>
        <input type="text" name="text_bluetooth" id="text_bluetooth"
               value="<?php echo !empty($rowTablet['bluetooth']) ? $rowTablet['text_bluetooth'] : ''; ?>"/>
    </td>
</tr>
...
<tr>
    ...
    <td>
        <input type="checkbox" name="lan" id="lan" <?php echo !empty($rowTablet['lan']) ? 'checked="checked"' : ''; ?>/>
    </td>
</tr>
...
<tr>
    ...
    <td>
        <input type="checkbox" name="wifi"
               id="wifi" <?php echo !empty($rowTablet['wifi']) ? 'checked="checked"' : ''; ?>/>
    </td>
    <td>
        <input type="text" name="text_wifi" id="text_wifi"
               value="<?php echo !empty($rowTablet['wifi']) ? $rowTablet['text_wifi'] : ''; ?>"/>
    </td>
</tr>
...
<tr>
    ...
    <td>
        <input type="checkbox" name="3g_modem"
               id="3g_modem" <?php echo !empty($rowTablet['3g_modem']) ? 'checked="checked"' : ''; ?>/>
    </td>
    <td>
        <input type="text" name="text_3g_modem" id="text_3g_modem"
               value="<?php echo !empty($rowTablet['3g_modem']) ? $rowTablet['text_3g_modem'] : ''; ?>"/>
    </td>
</tr>
...
<tr>
    ...
    <td>
        <input type="checkbox" name="usb_2"
               id="usb_2" <?php echo !empty($rowTablet['usb_2']) ? 'checked="checked"' : ''; ?>/>
    </td>
</tr>
...
<tr>
    ...
    <td>
        <input type="checkbox" name="usb_3"
               id="usb_3" <?php echo !empty($rowTablet['usb_3']) ? 'checked="checked"' : ''; ?>/>
    </td>
</tr>
...
<tr>
    ...
    <td>
        <input type="checkbox" name="hdmi"
               id="hdmi"<?php echo !empty($rowTablet['hdmi']) ? 'checked="checked"' : ''; ?> />
    </td>
</tr>
...
<tr>
    ...
    <td>
        <input type="checkbox" name="display_port"
               id="display_port" <?php echo !empty($rowTablet['display_port']) ? 'checked="checked"' : ''; ?>/>
    </td>
</tr>
...
<tr>
    ...
    <td>
        <input type="checkbox" name="audio_outputs"
               id="audio_outputs" <?php echo !empty($rowTablet['audio_outputs']) ? 'checked="checked"' : ''; ?>/>
    </td>
</tr>
...
<tr>
    ...
    <td>
        <input type="checkbox" name="docking_port"
               id="docking_port" <?php echo !empty($rowTablet['docking_port']) ? 'checked="checked"' : ''; ?>/>
    </td>
</tr>
...
<tr>
    ...
    <td>
        <input type="checkbox" name="gps" id="gps" <?php echo !empty($rowTablet['gps']) ? 'checked="checked"' : ''; ?>/>
    </td>
</tr>
...
<tr>
    ...
    <td>
        <input type="checkbox" name="electronic_compass"
               id="electronic_compass" <?php echo !empty($rowTablet['electronic_compass']) ? 'checked="checked"' : ''; ?>/>
    </td>
</tr>
...
<tr>
    <td>
        ...
        <label for="image_name" style="font-size:10px">(выбранное изображение в списке будет отображаться на главной
            странице,можно загружать на один планшет небольше 8 изображений,
            изображение загружаются в папку planshety. Первое изображение разрешения 250px(соблюдать
            обязательно)*177px(это значение можно от 170 до 180),
            второе изображение без изменений. Пример имени: 1-ая картинка - panasoniс_small.jpg, 2-ая картинка -
            panasoniс_full.jpg. _small и _full в имени изображений обязательны.), а пишем в строке только
            panasonic:</label>
    </td>
    <td>
        <!--                                        <input type="text" id="design" name="design" value="-->
...
<tr>
    ...
    <td>
        <textarea type="text" name="description_tablet"
                  id="description_tablet"><?php echo $rowTablet['description_tablet']; ?></textarea>
    </td>
</tr>
<tr>
    <td>
