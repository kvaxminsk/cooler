            ...
            <div id="right">
                ...
                <div id="text">
                    ...
                    <form id="form1" method="post" action="add_random_access_memory.php">
                        <input type="hidden" name="id_random_access_memory" id="id_random_access_memory" value="<?php echo  $idRandomAccessMemory;?>">
                        <table  border="0" cellspacing="10" cellpadding="340">
                            ...
                            <tr height="25px">
                                <td id="td_add_random_access_memory">
                                    ...
                                    <input type="text" id="name_random_access_memory" name="name_random_access_memory" value="<?php echo $rowRandomAccessMemory['name_random_access_memory'];?>">

                                    </br>
                                    <label>Размер оперативной памяти:</label>
                                    <input type="text" id="size_random_access_memory" name="size_random_access_memory" value="<?php echo $rowRandomAccessMemory['size_random_access_memory'];?>">
