...
<tr>
    <td>
        <label for="number_of_active_pixels_front_camera" style="font-size:15px">Количество активных пикселей
            фронтальной камеры:</label>
    </td>
    <td>
        <!--                                        <input type="text" id="design" name="design" value="-->
        <?php //echo $row['design'];?><!--"/><br/>-->
...
<tr>
    ...
    <td>
        <textarea type="text" name="description_tablet" id="description_tablet"></textarea>
    </td>
</tr>
<tr>
    <td>
