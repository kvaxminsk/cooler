            ...
            <div id="right">
                ...
                <div id="text">
                    ...
                    <form id="form1" method="post" action="add_power_unit.php">
                        <input type="hidden" name="id_power_unit" id="id_power_unit"
                               value="<?php echo $idPowerUnit; ?>">
