...
if (isset($_POST['id_cpu'])) {$idCpu = (int) htmlspecialchars(trim($_POST['id_cpu']));}
            ...
            <div id="right">
                ...
                <div id="text">
                    ...
                    if (isset($idCpu))
                    {
                        ...
                        $result = mysql_query("DELETE FROM cpu WHERE id=$idCpu");
                        if ($result == 'true')
                        {
                    ...
                    {
                        echo "<p>Вы не отметили процессор для удаления!</p>";
                    }
                    ?>
                </div>
