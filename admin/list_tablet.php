                                ...
                                <tr valign="top" align="left">
                                    <td id="td_edit">
                                        <a title="Редактировать"
                                           href="edit_tablet.php?id=<?php echo $row['id_tablet']; ?>">
                                            <img id="table_icon" src="images/form_edit.png">
                                        </a>
                                    </td>
                                    <td id="td_radio">
                                        <input id="radio" type="radio" value="<?php echo $row['id_tablet']; ?>"
                                               name="id">
                                    </td>
                                    <td id="td_edit">
                                    ...
                                    <td id="td_edit" width="10%" align="right">
                                        <strong>
                                            <a href="copy_tablet.php?id=<?php echo $row['id_tablet'] ?>"
                                               target="_blank">дублировать</a>
                                        </strong>
                                    </td>
                                </tr>
