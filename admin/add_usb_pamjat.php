...
<?php include ("index/menu.txt"); ?>
			...
			<!-- начало Right -->
			<div id="right">
             <div id="text"><h1>Добавление USB</h1><br /></div> 
             <div id="text"><br />
             <?php
...
{
$result = mysql_query("INSERT INTO usb_pamjat (title,image,cost,date) VALUES ('$title','$image','$cost','$date')");	


if ($result == 'true') {echo "<p>Данные успешно добавлены!</p>";}
