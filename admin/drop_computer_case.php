...
if (isset($_POST['id_computer_case'])) {$idComputerCase = (int) htmlspecialchars(trim($_POST['id_computer_case']));}
    ...
    <div id="page">
        ...
        <div id="bgbottom">
            ...
            <div id="right">
                ...
                <div id="text">
                    <?php
                    if (isset($idComputerCase))
                    {

                        $result = mysql_query("DELETE FROM computer_case WHERE id=$idComputerCase");
                        if ($result == 'true')
                        {
