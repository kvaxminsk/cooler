...
<div id="wrapper">
    ...
    <div id="page">
        ...
        <div id="bgbottom">
            ...
            <!-- начало Right -->
            <div id="right">
                <div id="text"><h1>Добавление ИБП</h1><br/></div>
                <div id="text"><br/>
                    <?php
  ...
  <tr>
	...
	<td id='td_tabl_sbor'><a href='edit_ibp.php'>Редактировать</a></td>
                    ...
                    <div id="forma">
                        ...
                        ?>
                        <form id="form1" method="post" action="add_ibp.php">
                            <table width="680" border="0" cellspacing="10" cellpadding="340">
                                <tr>
                                    <td><label>Ссылка на маленькое изображение <em>(пример: ibp/small/ibp-1.jpg)</em>.
                                ...
                                <tr>
                                    <td><label>Ссылка на большое изображение <em>(пример: ibp/ibp-1.jpg)</em>.
                                ...
                                <tr>
                                    ...
                                    <td><input name="time_p" type="text" id="time_p" size="60"/></td>
                                </tr>
                                <tr>
                                    <td><label>Время зарядки</label></td>
                                    <td><input name="time_z" type="text" id="time_z" size="60"/></td>
                                </tr>
                                <tr>
