  ...
  <tr>
	...
	<td id='td_tabl_sbor'><a href='edit_klaviaturji.php'>Редактировать</a></td>
                    ...
                    if (!isset($id))
                    {
                        ...
                        echo "<TABLE id='table_edit' ALIGN='center' CELLSPACING='2px'  bgcolor='#ffffff'><form action='drop_klaviaturji.php' method='post'>";
                    ...
                    else
                    {
                        ...
                        echo "<form id='form1' method='post' action='update_klaviaturji.php'> ";
                        print <<<HERE
