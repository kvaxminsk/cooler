                     ...
                     <form id="form1" method="post" action="add_cpu.php">
                        ...
                        <tr height="25px">
                                <td id="td_add_cpu">
                                    ...
                                    <input type="text" id="name_cpu" name="name_cpu" value="<?php echo $rowCpu['name_cpu'];?>">

                                    </br>
                                    <label>Количество ядер:</label>
                                    <input type="text" id="number_cores_cpu" name="number_cores_cpu" value="<?php echo $rowCpu['number_cores_cpu'];?>">

                                    </br>
                                    <label>Частота процессора:</label>
                                    <input type="text" id="speed_cpu" name="speed_cpu" value="<?php echo $rowCpu['speed_cpu'];?>">
