    ...
    <div id="page">
        ...
        <div id="bgbottom">
            ...
            <div id="right">
                ...
                <div id="text">
                    <?php
                    $result = mysql_query("SELECT distinct(cpu.id), cpu.name_cpu,cpu.number_cores_cpu, cpu.speed_cpu, system_block.id_cpu FROM  cpu
                                                LEFT JOIN system_block ON cpu.id = system_block.id_cpu ORDER BY cpu.name_cpu", $db);
                    ...
                    <table id='table_edit' ALIGN='center' CELLSPACING='2px'  bgcolor='#ffffff'>
                        <form action='drop_cpu.php' method='post'>
                            <?php
                            while($row = mysql_fetch_assoc($result))
                            {
                                ...
                                <tr valign="top" align="left">
                                    <td id="td_edit">
                                        <a title="Редактировать" href="edit_cpu.php?id_cpu=<?php echo $row['id'];?>">
                                    ...
                                    ?>
                                        <td id="td_radio">
                                            <input id="radio" type="radio" value="<?php echo $row['id'];?>" name="id_cpu">
                                        </td>
                                        <td id="td_edit">
