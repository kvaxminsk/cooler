    ...
    <div id="page">
        ...
        <div id="bgbottom">
            ...
            <div id="right">
                ...
                <div id="text">
                    <?php
                    $result = mysql_query("SELECT distinct(motherboard.id), motherboard.name_motherboard,system_block.id_motherboard FROM  motherboard
                                                LEFT JOIN system_block ON motherboard.id = system_block.id_motherboard ORDER BY motherboard.name_motherboard", $db);
                    ...
                    <table id='table_edit' ALIGN='center' CELLSPACING='2px'  bgcolor='#ffffff'>
                        <form action='drop_motherboard.php' method='post'>
                            <?php
                            while($row = mysql_fetch_assoc($result))
                            {
                                ...
                                <tr valign="top" align="left">
                                    <td id="td_edit">
                                        <a title="Редактировать" href="edit_motherboard.php?id_motherboard=<?php echo $row['id'];?>">
                                    ...
                                    <td id="td_edit1">
                                        <strong>
                                            ...
                                            $resultMotherboard = mysql_query("SELECT * FROM  system_block
                                                       ...
                                                       WHERE motherboard.id=" . $row['id'], $db);


                                            $showDeleteSubmit = 1;

                                            while($row1 = mysql_fetch_assoc($resultMotherboard))
                                            {
                                                $showDeleteSubmit = 0;
                                    ...
                                    if ($showDeleteSubmit != 0)
                                    {
                                        ?>
                                        <td id="td_radio">
                                            <input id="radio" type="radio" value="<?php echo $row['id'];?>" name="id_motherboard">
                                        </td>
                                        <td id="td_edit">
