...
if (!empty($insert['id_tablet'])) {
    ...
    if (isset($insert['protection_from_scratches'])) {
        ...
        $strSql .= "`protection_from_scratches`='" . 0 . "', ";
    }
